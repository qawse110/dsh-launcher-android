...
- **交互**：点击**桌宠本体**——挥手互动一次，气泡展开为**最近完整内容**（无内容时随机
  说一句台词；12 秒或状态变化后收起）；**快速连点 ≥5 次**会触发"主人别戳啦～"吐槽；
  点击**气泡**打开 dsh Web；**拖动松手后桌宠沿抛出方向做抛物线坠落**，撞左右墙反弹、
  落地小弹跳后静止并记忆位置（设置页「拖拽抛落」可关，改回普通拖动定位）；
