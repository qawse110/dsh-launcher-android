...
class BackupActivity : AppCompatActivity() {
    ...
    private fun doRestore(item: BackupManager.Item) {
        ...
        thread {
            ...
            runCatching {
                com.dsh.nextapp1.service.BuildKeepAliveService.markStopped(this@BackupActivity)
                stopService(android.content.Intent(this@BackupActivity, com.dsh.nextapp1.service.BuildKeepAliveService::class.java))
            }
            logQuiet("✓ dsh 服务已停止")
