/**
 * dsh-oh-we-need — oh-we-need 推理风格 Skill 插件。
 *
 * 不再注入系统提示词；改为在 ctx.skills 注册一个 bundled skill provider，
 * 把 oh-we-need 作为可按需调用的 SKILL.md 提供。
 */
...
const PROVIDER_NAME = 'dsh-oh-we-need'
