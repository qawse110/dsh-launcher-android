---
name: oh-we-need
description: "Use this skill when the user expects the oh-we-need reasoning style: concise action-first chain-of-thought using 'we need to ...' / 'we need ...' as the core pattern."
whenToUse: "Use for software engineering and coding tasks where internal reasoning should follow the we-need-to sentence pattern with modal verbs, task classification, and think tags."
---
